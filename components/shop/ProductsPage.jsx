...
export function ProductsPage() {
  ...
  useEffect(() => {
    ...
    setFarm(params.get('farm') || 'all');
  }, [params.toString()]);
  useEffect(() => {
    setPage(1);
  }, [query, category, farm, sort]);

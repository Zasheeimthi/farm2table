/** Inline SVG artwork shared by the home category cards and the home filter row. */
export default function CategoryArtwork({ category }) {
  ...
  return (
    <svg viewBox="0 0 84 84" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      {artwork[category]}
    </svg>
  );
}

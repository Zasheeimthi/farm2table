/**
 * Farm to Table catalogue.
 *
 * Plain data only so it can be imported by Server Components as well as Client
 * Components. Category artwork/icons live in components/common/CategoryIcon.jsx
 * because they are React elements and must render on the client.
 */

export const categories = [
  { id: 'all', label: 'All Produce' },
  { id: 'meat-fish', label: 'Meat, Chicken & Fish' },
  { id: 'dairy', label: 'Dairy & Cheese' },
  { id: 'vegetables', label: 'Vegetables & Roots' },
  { id: 'pantry', label: 'Pantry' },
  { id: 'drinks', label: 'Drinks' },
  { id: 'kitchen', label: 'To the Kitchen' }
];

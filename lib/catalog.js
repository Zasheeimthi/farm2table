 ...
 *
 * This is the fallback used when no external backend is configured. The API
 * layer (app/api/*) serves these same shapes from your backend when
 * BACKEND_API_URL is set, so components never need to change.
 */
...
export const categoryTabs = [
  { id: 'all', label: 'All Produce', icon: 'appstore' },
  { id: 'meat-fish', label: 'Meat, Chicken & Fish', icon: 'skin' },
  { id: 'dairy', label: 'Dairy & Cheese', icon: 'coffee' },
  { id: 'vegetables', label: 'Vegetables & Roots', icon: 'home' },
  { id: 'pantry', label: 'Pantry', icon: 'inbox' },
  { id: 'drinks', label: 'Drinks', icon: 'compass' },
  { id: 'kitchen', label: 'To the Kitchen', icon: 'shopping' }
];

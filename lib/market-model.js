/**
 * Pure basket + delivery model.
 *
 * Nothing in here touches the DOM, browser storage or the Next.js router, so it
 * can be imported from Server Components, Client Components and node:test runs
 * alike.
 */
